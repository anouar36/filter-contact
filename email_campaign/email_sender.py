...
<head>
  ...
  <style>
    ...
    h1 {{
      ...
      font-size: 36px;
      font-weight: 700;
      /* TITRE EN BORDEAUX PROFESSIONNEL */
      color: #800020;
      margin: 0 0 10px 0;
    }}
    .title {{
  ...
  <div class="container">
    ...
    <div class="cv-section">
      <p class="highlight" style="margin-bottom: 5px;">
        <img src="https://img.icons8.com/color/20/resume.png" alt="CV" style="vertical-align: middle; margin-right: 5px;"> <strong>Mon CV et réalisations sont disponibles en ligne :</strong>
      </p>
      <div class="cv-links">
        <a href="https://anouar-echcharai.vercel.app/" target="_blank"><img src="https://img.icons8.com/ios-filled/14/ffffff/domain.png" alt="Web" style="vertical-align: middle; margin-right: 4px; border: none; margin-bottom: 2px;"> Portfolio Complet</a>
        <a href="https://www.linkedin.com/in/anouar-ech-charai/" target="_blank"><img src="https://img.icons8.com/ios-filled/14/ffffff/linkedin.png" alt="In" style="vertical-align: middle; margin-right: 4px; border: none; margin-bottom: 2px;"> Profil LinkedIn</a>
      </div>
